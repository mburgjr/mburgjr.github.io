...
Hello! I am a recent graduate from MIT, now working full-time at [RAI Institute](https://rai-inst.com/) as an Applied Scientist. In this role, I am working to develop control pipelines for an agile manipulation platform capable of completing dynamic actions at high speeds with high accuracy and repeatability. I am interested in exploring approaches from traditional optimal control to RL and other learning-based methods in close alignment with hardware design toward proficient embodied intelligence.
